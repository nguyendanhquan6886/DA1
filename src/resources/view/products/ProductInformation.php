...
?>
    ...
    ?>
        ...
        ?>
            ...
            ?>
            <input type="text" value="<?=$pro_id?>" name="pro_id" hidden>
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6 col-12">
                    ...
                    <?php
                        $sql1 = "select distinct size_id from pro_chitiet where pro_id = $pro_id";
                        $size_id = pdo_queryall($sql1);
                    foreach ($size_id as $proSize) { 
                    ...
                    <div class="mt-4 d-flex">
                        ...
                        <?php
                            $sql = "select distinct color_id from pro_chitiet where pro_id = $pro_id";
                            $color_id = pdo_queryall($sql);
                        foreach ($color_id as $proColor) { 
    ...
    <div class="mb-3 mt-3">
      ...
      <textarea class="form-control" rows="5" id="comment" name="cmt_content" required></textarea>
    </div>
