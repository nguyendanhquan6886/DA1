    ...
    <form action="index.php?act=orderone " method="post">
        <div class="row">
            <div class="col">
                ...
                <input type="text" class="form-control mt-2 fs-6 placeholder-sm " name="fullname" id="fullname" placeholder="Enter your full name*" value="<?=$_SESSION['acount']['kh_name']?>">
                ...
                <div class="form-group mt-3">
                <input type="text" class="form-control mt-2 fs-6 placeholder-sm " name="address" id="address" placeholder="Enter your detailed address*" value="<?= $_SESSION['acount']['kh_address']?>">
            ...
            <div class="col">
                ...
                if (isset($_GET['pro_id'])) {
                    ...
                    $totalPrice = (int)$pro['pro_price'] * (int)$_GET['sl'];
                    $shipingPrice = 10;
                    
                ?>
                        <div>
                            <div class="mt-3 cart-item d-flex gap-3 border-bottom align-items-center w-100">
                                <input type="text" name="size" id="" value="<?=$_GET['size']?>" hidden>
                                <input type="text" name="color" id="" value="<?=$_GET['color']?>" hidden>
                                <input type="text" name="soluong" id="" value="<?=$_GET['sl']?>" hidden>
                                ...
                                <div class="d-flex flex-column flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-end ">
                                        ...
                                        <input class="ps-2 w-25" type="number" name="" min="1" max="99" value="<?=$_GET['sl']?>">
                                    </div>
                                </div>
