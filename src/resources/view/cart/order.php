...
if (isset($_POST['placeordered'])) {
    if ($_POST['district'] == null || $_POST['ward'] == null || $_POST['city'] == null || $_POST['thanhtoan'] == 0) {
        $tb = '&thongbao=';
        $space = '  ';
        $thongbao = "Please enter the complete data field$space";
        header("Location:index.php?act=checkout&kh_id=" . $_SESSION['acount']['kh_id'] . $tb . $thongbao);
