...
<div class="container">
        <h2 class="border border-4 mb-4 text-bg-secondary p-3 text-center rounded">Thêm mới chi tiết sản phẩm</h2>
        <div class="container text-bg-light rounded">
            ...
            <form action="indexadmin.php?act=addpro_ct" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="giasp" placeholder="ID SanR Phẩm" name="pro_id" value="<?= $pro_id ?>" required>
                </div>
                <?php
                    }
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="number" class="form-control" id="giasp" placeholder="Brand" name="soluong" required>
                </div>
                ...
                <div class="">
                    ...
                    <a href="indexadmin.php?act=chitietadmin&pro_id=<?php echo $pro_id?>">
