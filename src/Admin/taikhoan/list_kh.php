                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <a href="indexadmin.php?act=soft_xoatk&kh_id=<?php echo $kh_id ?>"><input type="button" class="mb-2 text-bg-success rounded" onclick="return confirm('Bạn có chắc muốn vô hiệu hoá tài khoản ?')" name="" value="Vô hiệu hoá tk" id=""></a>
                                  </td>
                                </tr>
                              <?php  } ?>
                              </tbody>
