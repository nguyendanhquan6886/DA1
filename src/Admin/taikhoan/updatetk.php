                ...
                <div class="container text-bg-light rounded">
                    ...
                    <form action="indexadmin.php?act=updatetk" method="post">
                         <div class="mb-3 mt-3">
                            ...
                            <input type="number" class="form-control" id="kh_id " placeholder="Tên đăng nhập" value="<?= $kh_id ?>" name="kh_id" required>
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="kh_name" class="form-label text-danger">Tên đăng nhập:</label>
                            <input type="text" class="form-control" id="kh_name" placeholder="Tên đăng nhập" value="<?= $kh_name ?>" name="kh_name" required>
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="kh_pass" class="form-label text-danger">Mật khẩu:</label>
                            <input type="text" class="form-control" id="kh_pass" placeholder="Mật khẩu" value="<?= $kh_pass ?>" name="kh_pass" required>
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="kh_mail" class="form-label text-danger">Email:</label>
                            <input type="email" class="form-control" id="kh_mail" placeholder="Email" value="<?= $kh_mail ?>" name="kh_mail" required>
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="kh_address" class="form-label text-danger">Địa chỉ:</label>
                            <input type="text" class="form-control" id="kh_address" placeholder="Địa chỉ" value="<?= $kh_address ?>" name="kh_address" required>
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="kh_tel" class="form-label text-danger">Số điện thoại:</label>
                            <input type="tel" class="form-control" id="kh_tel" placeholder="Số điện thoại" value="<?= $kh_tel ?>" name="kh_tel" required>
                        </div>
                        <div class="mb-3 mt-3">
